...
const disconnectUser = async (req, res, next) => {
  try {
    ...
    currentUser.connections = (currentUser.connections || []).filter(
      id => id.toString() !== userToDisconnectId
    );
...
module.exports = { getProfile, getUserByUsername, updateProfile, searchUsers, connectUser, disconnectUser, getNetwork };
